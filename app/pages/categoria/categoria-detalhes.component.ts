...
@Component({
    selector: 'categoria',
    templateUrl: 'app/pages/categoria/categoria-detalhes.component.html',
    styleUrls: ['app/pages/categoria/categoria-detalhes.component.css'],
...
export class CategoriaDetalhesComponent implements OnInit {
    ...
    constructor(params: RouteParams,
        private _tipoEnsinoService: CategoriaService,
